...
- HuggingFace Accelerate는 CLI 기반 launcher라 노트북 only 방식에 적합하지 않습니다. [`02-script-based/06-launch_accelerator_single_node.ipynb`](../02-script-based/06-launch_accelerator_single_node.ipynb)와 [`07-launch_accelerator_multi_node.ipynb`](../02-script-based/07-launch_accelerator_multi_node.ipynb) 참고.
