...
03-custom-package-script-based의 모든 trainer (TorchDistributor / Lightning / Accelerate)가
공통으로 import한다. 02-script-based/model.py와 동작·시그니처가 동일하며, 차이는
import 경로(`recommender_pkg.model`)뿐.

기준 모델 정의는 00-foundations/recommender-baseline.md.
"""
