...
|------------------|------------------|-------------------|---------------|
| **01-notebook-based** | [02 · TorchDistributor — 1×1 / 1×N GPU](01-notebook-based/02-train_torch_distributor_1x1_1xN.ipynb)<br>[03 · TorchDistributor — M×N GPU](01-notebook-based/03-train_torch_distributor_MxN.ipynb) | [04 · Lightning — 1×1 / 1×N GPU](01-notebook-based/04-train_pytorch_lightning_1x1_1xN.ipynb)<br>[05 · Lightning — M×N GPU](01-notebook-based/05-train_pytorch_lightning_MxN.ipynb) | — (CLI 기반이라 N/A) |
| **02-script-based** | [02 · TorchDistributor — 1×1 GPU](02-script-based/02-launch_torch_distributor_1x1.ipynb)<br>[03 · TorchDistributor — 1×N GPU](02-script-based/03-launch_torch_distributor_1xN.ipynb)<br>[04 · TorchDistributor — M×N GPU](02-script-based/04-launch_torch_distributor_MxN.ipynb) | [05 · Lightning — 1×1 GPU](02-script-based/05-launch_lightning_trainer_1x1.ipynb)<br>[06 · Lightning — 1×N GPU](02-script-based/06-launch_lightning_trainer_1xN.ipynb)<br>[07 · Lightning — M×N GPU](02-script-based/07-launch_lightning_trainer_MxN.ipynb) | [08 · Accelerate — M×N GPU (subprocess.Popen)](02-script-based/08-launch_accelerator_MxN.ipynb) |
| **03-custom-package-script-based** | [02 · TorchDistributor — 1×1 GPU](03-custom-package-script-based/02-launch_torch_distributor_1x1.ipynb)<br>[03 · TorchDistributor — 1×N GPU](03-custom-package-script-based/03-launch_torch_distributor_1xN.ipynb)<br>[04 · TorchDistributor — M×N GPU](03-custom-package-script-based/04-launch_torch_distributor_MxN.ipynb) | [05 · Lightning — 1×1 GPU](03-custom-package-script-based/05-launch_lightning_trainer_1x1.ipynb)<br>[06 · Lightning — 1×N GPU](03-custom-package-script-based/06-launch_lightning_trainer_1xN.ipynb)<br>[07 · Lightning — M×N GPU](03-custom-package-script-based/07-launch_lightning_trainer_MxN.ipynb) | [08 · Accelerate — M×N GPU (subprocess.Popen, wheel 모듈 모드)](03-custom-package-script-based/08-launch_accelerator_MxN.ipynb) |

02·03 행은 launcher마다 1×1 / 1×N / M×N을 별도 노트북으로 분리했습니다. 한 노트북에서 `TorchDistributor.run`을 연속 호출하면 py4j callback이 단절되는 현상을 피하기 위함입니다. Accelerate는 단일 노트북에서 가시 GPU 수를 자동 감지해 1×1/1×N/M×N을 모두 다루며, 실행은 `subprocess.Popen` 패턴을 따릅니다. 자세한 노트북 목록은 [`02-script-based/README.md`](02-script-based/README.md), [`03-custom-package-script-based/README.md`](03-custom-package-script-based/README.md)을 참고하세요.
...
01-notebook-based 행은 `1x1_1xN` 노트북에서 1×1·1×N을 한 노트북의 섹션으로 함께 다루고, `MxN` 노트북에서 M×N을 따로 다룹니다. 02·03 행은 launcher × 토폴로지별로 노트북이 분리되어 파일명에 `1x1` / `1xN` / `MxN`이 들어갑니다.
