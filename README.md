...
| **02-script-based** | [`02-launch_torch_distributor_single_node.ipynb`](02-script-based/02-launch_torch_distributor_single_node.ipynb) (1×1, 1×N)<br>[`03-launch_torch_distributor_multi_node.ipynb`](02-script-based/03-launch_torch_distributor_multi_node.ipynb) (M×N) | [`04-launch_lightning_trainer_single_node.ipynb`](02-script-based/04-launch_lightning_trainer_single_node.ipynb) (1×1, 1×N)<br>[`05-launch_lightning_trainer_multi_node.ipynb`](02-script-based/05-launch_lightning_trainer_multi_node.ipynb) (M×N) | [`06-launch_accelerator_single_node.ipynb`](02-script-based/06-launch_accelerator_single_node.ipynb) (1×1, 1×N)<br>[`07-launch_accelerator_multi_node.ipynb`](02-script-based/07-launch_accelerator_multi_node.ipynb) (M×N) |
...
01-notebook-based와 02-script-based는 single-node와 multi-node 클러스터 요구사항이 달라 노트북을 분리했습니다. 03 행은 노트북 안 섹션으로 토폴로지를 비교합니다 (TBD).
